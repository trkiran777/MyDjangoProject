...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contact_web_app_contact', (
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('phone_no', self.gf('django.db.models.fields.CharField')(max_length=10, primary_key=True)),
            ...
            ('pin_code', self.gf('django.db.models.fields.CharField')(max_length=6, blank=True)),
        ))
        db.send_create_signal(u'contact_web_app', ['Contact'])

        # Adding model 'Provider'
        db.create_table(u'contact_web_app_provider', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('provider_name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('series_list', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=50)),
        ))
        db.send_create_signal(u'contact_web_app', ['Provider'])


    def backwards(self, orm):
        # Deleting model 'Contact'
        db.delete_table(u'contact_web_app_contact')

        # Deleting model 'Provider'
        db.delete_table(u'contact_web_app_provider')
